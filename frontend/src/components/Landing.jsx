    ...
    <div className="min-h-screen bg-gradient-to-br from-nurture-cream via-white to-nurture-sand overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://github.com/krittaphato3/DataModel-Project-Mental-Wellness" // ← replace with your actual repo
              target="_blank"
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          <motion.div variants={fadeUp} whileHover={{ scale: 1.01 }} className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 md:p-10 border border-stone-200/50 shadow-sm">
            <h2 className="text-2xl md:text-3xl font-serif font-bold text-stone-800 mb-4">Designed with clarity and purpose.</h2>
            <p className="text-stone-600 mb-6 leading-relaxed">Your privacy is paramount. All responses are anonymised and secured.</p>
            <button
              onClick={() => navigate('/statistics')}
              className="px-8 py-3 bg-stone-800 text-white rounded-full font-semibold text-base shadow-md transition-all duration-300 hover:bg-stone-700 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0"
            >
